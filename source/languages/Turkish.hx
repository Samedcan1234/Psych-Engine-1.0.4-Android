...
class Turkish implements ILanguage
{
    ...
    public var phrases:Map<String, String> = [
        ...
        "safemode_title"         => "Güvenli Mod Aktif",
        "safemode_message"       => "Önceki oturumda bir hata oluştu.\nModlar güvenlik nedeniyle geçici olarak devre dışı bırakıldı.",
        "safemode_mods_info"     => "Sorunlu modlar:",
        "safemode_reenable_hint" => "Modları ayarlardan tekrar etkinleştirebilirsiniz.",
        
        "language_changed_title" => "Dil Değiştirildi!",
        "language_changed_msg"   => "Türkçe diline geçildi.",
        "language_locked_title"  => "Dil Kilitli!",
        "language_locked_msg"    => "Bu dil şu anda kullanılamıyor.",
        ...
        "graphics_potatomode"        => "Patates Modu",
        "graphics_potatomode_desc"   => "Aktif Edilirse Oyun-içi herşeyi devre dışı bırakarak (karakterler, arkaplan vs.) OSU tarzı sağlar ve performansı ciddi şekilde arttırır.",
        ...
        "peu_ultramodsystem"      => "Ultra Mod Sistemi",
        "peu_ultramodsystem_desc" => "Aktif Edildiğinde, Ultra Mod Sistemi Kullanılır ve Psych Engine Ultra ile daha uyumlu olur",
        ...
        "reset_score_title" => "Skoru Sıfırla?",
        "yes"            => "Evet",
        "no"             => "Hayır",
        
        "freeplay_title"                => "SERBEST OYUN",
        "freeplay_songs"                => "Şarkı",
        "freeplay_result"               => "sonuç",
        "freeplay_random"               => "RASTGELE",
        "freeplay_random_subtitle"      => "Rastgele bir şarkı seç!",
        "freeplay_song_name"            => "ŞARKI ADI",
        "freeplay_hint_pc"              => "F: Ara | TAB: Filtre",
        "freeplay_hint_mobile"          => "Z: Ara | Y: Filtre",
        "freeplay_search_prompt"        => "ARA",
        "freeplay_score_label"          => "◈ SKOR",
        "freeplay_score_label_short"    => "Skor: ",
        "freeplay_accuracy_label"       => "İsabet: ",
        "freeplay_grade_na"             => "Y/B",
        "freeplay_difficulty_label"     => "◈ ZORLUK",
        "freeplay_stats_label"          => "◈ İSTATİSTİK",
        "freeplay_stat_total"           => "Toplam: ",
        "freeplay_stat_favorites"       => "Favoriler: ",
        "freeplay_stat_completed"       => "Tamamlanan: ",
        "freeplay_week_prefix"          => "Hafta ",
        "freeplay_controls_pc"          => "ENTER: Seç  ESC: Geri  SPACE: Çal  TAB: Kategori  F: Ara",
        "freeplay_controls_mobile"      => "A: Seç  B: Geri  X: Çal  Y: Kategori  Z: Ara",
        "freeplay_menu_modifiers"       => "OYNANIŞ MODİFİKASYONLARI",
        "freeplay_menu_reset"           => "SKORU SIFIRLA",
        "freeplay_menu_back"            => "GERİ",
        "freeplay_tip_search_mobile"    => "🔍 Ara — A: Onayla  B: İptal",
        "freeplay_tip_searchbox_mobile" => "⌨ Arama kutusu aktif — A/B: Kapat",
        "freeplay_tip_category"         => "📂 Kategori: ",
        "freeplay_tip_fav_added"        => "Favorilere Eklendi: ",
        "freeplay_tip_fav_removed"      => "Favorilerden Çıkarıldı: ",
        "freeplay_tip_hidden_added"     => "🙈 Gizlilere Eklendi: ",
        "freeplay_tip_hidden_removed"   => "👁 Gizlilerden Çıkarıldı: ",
        "freeplay_tip_reset"            => "🗑 Skor Sıfırlanıyor...",
        "freeplay_tip_menu_mobile"      => "↕ Seç  A: Onayla  B: Geri  ←/→: Zorluk",
        "freeplay_category_all"         => "TÜMÜ",
        "freeplay_category_favorites"   => "FAVORİLER",
        "freeplay_category_last_played" => "SON OYNANAN",
        "freeplay_category_hidden"      => "GİZLİ",
        ...
        "code_menu_prompt"     => "Gizli Kodu Girin:",
        "code_menu_back"       => "ESC tuşu ile ana menüye geri dön",
        "code_menu_enter_code" => "Kodu Gir.",
        "code_menu_unknown"    => "Bilinmeyen Kod!",
        "code_menu_hold_skip"  => "Geçmek için Basılı Tutun",
