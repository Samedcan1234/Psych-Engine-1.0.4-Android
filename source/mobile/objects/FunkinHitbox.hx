...
class FunkinHitbox extends Hitbox {
	...
	public function new(?mode:String, ?showHints:Bool):Void
	{
		...
		if (ClientPrefs.data.extraButtons == 1 && MobileConfig.hitboxModes.get(Custom).single != null)
			currentHint = MobileConfig.hitboxModes.get(Custom).single;
		if (ClientPrefs.data.extraButtons == 2 && MobileConfig.hitboxModes.get(Custom).double != null)
			currentHint = MobileConfig.hitboxModes.get(Custom).double;
		if (ClientPrefs.data.extraButtons == 3 && MobileConfig.hitboxModes.get(Custom).triple != null)
			currentHint = MobileConfig.hitboxModes.get(Custom).triple;
		if (ClientPrefs.data.extraButtons == 4 && MobileConfig.hitboxModes.get(Custom).quad != null)
			currentHint = MobileConfig.hitboxModes.get(Custom).quad;
		if (ClientPrefs.data.extraButtons != 0 && MobileConfig.hitboxModes.get(Custom).hints != null)
		...
		for (buttonData in currentHint)
		{
			...
			if (ClientPrefs.data.extraButtons == 0 && buttonData.extraKeyMode == 0 ||
			   ClientPrefs.data.extraButtons == 1 && buttonData.extraKeyMode == 1 ||
			   ClientPrefs.data.extraButtons == 2 && buttonData.extraKeyMode == 2 ||
			   ClientPrefs.data.extraButtons == 3 && buttonData.extraKeyMode == 3 ||
			   ClientPrefs.data.extraButtons == 4 && buttonData.extraKeyMode == 4 ||
